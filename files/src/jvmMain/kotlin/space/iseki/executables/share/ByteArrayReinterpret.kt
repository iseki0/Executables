 ...
 */
internal actual fun ByteArray.u1(offset: Int): UByte = (this[offset].toUInt() and 0xFFu).toUByte()
 ...
 */
internal actual fun ByteArray.u2l(offset: Int): UShort =
 ...
 */
internal actual fun ByteArray.u4l(offset: Int): UInt =
 ...
 */
internal actual fun ByteArray.u8l(offset: Int): ULong =
 ...
 */
internal actual fun ByteArray.u2b(offset: Int): UShort =
 ...
 */
internal actual fun ByteArray.u4b(offset: Int): UInt =
