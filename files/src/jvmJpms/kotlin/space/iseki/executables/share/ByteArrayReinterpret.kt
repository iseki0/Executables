 ...
 */
internal fun ByteArray.u1(offset: Int): UByte = this[offset].toUByte()
 ...
 */
internal fun ByteArray.u2l(offset: Int): UShort = (SHORT_VIEW_LE.get(this, offset) as Short).toUShort()
 ...
 */
internal fun ByteArray.u4l(offset: Int): UInt = (INT_VIEW_LE.get(this, offset) as Int).toUInt()
 ...
 */
internal fun ByteArray.u8l(offset: Int): ULong = (LONG_VIEW_LE.get(this, offset) as Long).toULong()
 ...
 */
internal fun ByteArray.u2b(offset: Int): UShort = (SHORT_VIEW_BE.get(this, offset) as Short).toUShort()
 ...
 */
internal fun ByteArray.u4b(offset: Int): UInt = (INT_VIEW_BE.get(this, offset) as Int).toUInt()


internal fun ByteArray.u8b(offset: Int): ULong = (LONG_VIEW_BE.get(this, offset) as Long).toULong()
