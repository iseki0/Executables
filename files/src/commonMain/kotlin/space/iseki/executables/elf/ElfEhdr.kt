...
sealed interface ElfEhdr : ReadableStructure {
    ...
    val eVersion: ElfPrimitive
    val eEntry: ElfPrimitive
    val ePhoff: ElfPrimitive
    val eShoff: ElfPrimitive
    val eFlags: ElfPrimitive
    val eEhsize: ElfPrimitive
    val ePhentsize: ElfPrimitive
    val ePhnum: ElfPrimitive
    val eShentsize: ElfPrimitive
    val eShnum: ElfPrimitive
    val eShstrndx: ElfPrimitive
