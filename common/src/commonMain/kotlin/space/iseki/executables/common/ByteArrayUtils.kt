 ...
 */
@ExeInternalApi
fun ByteArray.u1(offset: Int): UByte = (this[offset].toUInt() and 0xFFu).toUByte()
 ...
 */
@ExeInternalApi
fun ByteArray.u2l(offset: Int): UShort =
 ...
 */
@ExeInternalApi
fun ByteArray.u4l(offset: Int): UInt =
 ...
 */
@ExeInternalApi
fun ByteArray.u8l(offset: Int): ULong =
 ...
 */
@ExeInternalApi
fun ByteArray.u2b(offset: Int): UShort =
 ...
 */
@ExeInternalApi
fun ByteArray.u4b(offset: Int): UInt =
 ...
 */
@ExeInternalApi
fun ByteArray.u8b(offset: Int): ULong =
